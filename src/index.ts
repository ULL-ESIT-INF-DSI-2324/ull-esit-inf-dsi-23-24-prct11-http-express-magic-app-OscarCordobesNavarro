...
const carta1: ICard = {
  ...
  const carta3: ICard = {
    ...
    ruleText: "Cuando el Chamán de los Bosques entre al campo de batalla, puedes buscar en tu biblioteca una carta de tierra básica y ponerla en el campo de batalla girada.",
    strength: 2,
    endurance: 1,
    marketValue: 5
  };
  ...
  const carta4: ICard = {
    ...
    rarity: Rarity.Common,
    ruleText: "Lava Spike hace 3 puntos de daño a cualquier objetivo. Siempre que un oponente reciba daño de una carta llamada Lava Spike en un turno, ese jugador pierde 3 puntos de vida.",
    marketValue: 2
  };
  ...
  const carta5: ICard = {
    ...
    lineType: TypeLine.Artifact,
    rarity: Rarity.Common,
    ruleText: "Trample (Si esta criatura fuera a hacer suficiente daño de combate a sus bloqueadores para destruirlos, puedes hacer que el resto del daño de combate sea hecho al jugador defensor).\n{4}: Regenera el Gólem de Acero.",
    strength: 3,
    endurance: 3,
    marketValue: 8
  };
  ...
  const carta8: ICard = {
    ...
    lineType: TypeLine.Sorcery,
    rarity: Rarity.Rare,
    ruleText: "Ira del Dragón hace 5 puntos de daño a cada criatura sin volar y a cada jugador.",
    marketValue: 30
  };
  ...
  const carta9: ICard = {
    ...
    rarity: Rarity.Uncommon,
    ruleText: "Las cartas de hechizo que juegues no pueden ser contrarrestadas este turno.\nGanas 1 vida por cada carta de hechizo verde que juegues este turno.",
    marketValue: 25
  };
const carta10: ICard = {
  id: 10,
